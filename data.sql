...
(5, 'Noah Davis', '2005-03-18', 'davisnoah@gmail.com', '654 Cedar St, Boroughville', '555-5678', 'D5678901', 'HealthPlus', 'Patricia Davis', '229-295-9012');
...
(4, 'NCAT vs. NCCU Football Game', '2024-11-20', '12:00:00', '1601 E Market St, Greensboro, NC 27411', 'Exciting football game between NCAT and NCCU.'),
...
(1, 'Toyota', 'Corolla', 2020, 'ABC123', 'Available'),
(2, 'Honda', 'Civic', 2019, 'XYZ789', 'Available'),
(3, 'Ford', 'Mustang', 2022, 'LMN456', 'Unavailable'),
(4, 'Chevrolet', 'Traverse', 2023, 'DEF321', 'Available'),
(5, 'Nissan', 'Altima', 2025, 'GHI654', 'Unavailable');
...
(1, 'Laila Moreno', '483-921-6753', 'laymoreno483@email.com', 'D6789012', 4.5, 'Available'),
(2, 'Tristan Cole', '760-184-9326', 'tristan760@email.com', 'D7890123', 4.8, 'Unavailable'),
(3, 'Amara Bennett', '295-608-4127', 'amaraaab.com', 'D8901234', 4.7, 'Available'),
(4, 'Devon Price', '819-237-5014', 'priced052.com', 'D9012345', 4.6, 'Available'),
(5, 'Selene Carter', '634-872-1591', 'selenecarter62.com', 'D0123456', 4.4, 'Unavailable');
